...
[this beautiful page](https://en.wikipedia.org/wiki/Tiling_by_regular_polygons).
...
library. As I said: [*NIH*](https://en.wikipedia.org/wiki/Not_Invented_Here#In_computing)!)
...
["round halfway from zero"](https://en.wikipedia.org/wiki/Rounding#Tie-breaking):
