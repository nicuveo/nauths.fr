...
[Mænder Alkoor](https://www.synopsite.com/articles.php?lng=fr&pg=43).
...
[pavages réguliers et semi-réguliers](https://en.wikipedia.org/wiki/Tiling_by_regular_polygons).
...
et à la main
([*NIH*](https://en.wikipedia.org/wiki/Not_Invented_Here#In_computing), vous
...
([*BOOST_PP*](https://www.boost.org/doc/libs/release/libs/preprocessor/doc/index.html)&nbsp;!
Dem
[templatez](https://en.wikipedia.org/wiki/Template_%28C%2B%2B%29)&nbsp;!),
...
[la terminologie de *Wikipédia*](https://en.wikipedia.org/wiki/Rounding#Tie-breaking).
Concrètement&nbsp;:
