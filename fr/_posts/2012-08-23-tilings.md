...
Tout n'a bien sûr pas marché du premier coup&nbsp;: erreurs de compilation à
rallonge et illisibles à cause des techniques de méta-méta-programmation
employées ([*BOOST_PP*](http://www.boostpro.com/mplbook/preprocessor.html)&nbsp;!
Dem [templatez](http://en.wikipedia.org/wiki/Template_%28C%2B%2B%29)&nbsp;!),
fautes de frappes, confusion dans les coordonnées... Mais il y a eu bien assez
vite un Bug majeur, celui qui nécessite de réécrire une partie du code.
